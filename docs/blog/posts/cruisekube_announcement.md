...
- **Runtime Optimizer**: Continuously optimizes pod-level resources for running pods across the cluster. It leverage the statistics generated by the statistics engine to generate recommendations per pod

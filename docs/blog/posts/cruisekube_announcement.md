...
- **Runtime Optimizer**: Continuously optimizes pod level reosurces for running pods across the cluster. It leverage the statistics generated by the statistics engine to generate recommendations per pod
...
By open sourcing CruiseKube, we are pushing the boundarise of what is possible with kubernetes resource optimization. Do get involved in the community by joining our [Discord](https://discord.gg/Dqek4xJa3N) server and sharing your feedback and ideas. 
